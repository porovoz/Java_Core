package course02.lesson08.transport;
...
//            throw new IllegalArgumentException("The driver can not be null");
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(transport.engineVolume, engineVolume) == 0 && mechanicQuantity == transport.mechanicQuantity && Objects.equals(brand, transport.brand) && Objects.equals(model, transport.model) && Objects.equals(drivers, transport.drivers) && Objects.equals(mechanics, transport.mechanics) && Objects.equals(driver, transport.driver);
    }

    @Override
    public int hashCode() {
        return Objects.hash(brand, model, engineVolume, drivers, mechanics, mechanicQuantity, driver);
    }
