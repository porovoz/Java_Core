...
public class Bus extends Transport {
    ...
    public Bus(String brand, String model, int productionYear, String productionCountry, String bodyColor, int maximumSpeed) {
    ...
    public String toString() {
        return "Brand: " + getBrand() + ", " + "Model: " + getModel() + ", " + "Year of production: " + getProductionYear() + ", " +
                "Production country: " + getProductionCountry() + ", " + "Body color: " + getBodyColor() + ", " +
